 ...
 * @date 2019/11/12.
 */
public abstract class GuidePageTransformer implements ViewPager.PageTransformer {
    ...
    public static GuidePageTransformer getPageTransformer(TransitionEffect effect) {
        switch (effect) {
            case Default:
